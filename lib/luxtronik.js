 ...
 */
Luxtronik.prototype.createClient = function() {
    ...
    this.client.on('timeout', function () {
        ...
        this.client.destroy(createError.bind(this)("Timeout after " + this._timeout + " ms"));
        this.client = null;
...
Luxtronik.prototype.read = function (callback) {
    this.receivy = {
        jobs: typeConfiguration.getReadableDataTypes(),
        activeCommand: 0,
    ...
    this.client.on('data', function (data) {
        ...
        if (this.receivy.activeCommand === 0) {
            ...
            let firstReadableDataAddress = typeConfiguration.dataTypes[datatype].firstReadableDataAddress;
            let bytelength = typeConfiguration.dataTypes[datatype].bytelength;
